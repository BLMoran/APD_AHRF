...
arf <- arf |> select(-c(CountryCode, IcuAdmitYYYYMM, ICUAdmitFinYr))
...
arf_binary <- glmer(as.numeric(DIED_HOSP) ~ 0 + AHRF +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
...
# Run MLM
arf_freqmodel <- glmer(as.numeric(DIED_HOSP) ~ 0 + pf_cont +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
                             family = binomial(link = "logit"), data = arf, nAGQ = 0,
                             glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
...
# Run MLM
arf_model_hosp_mort <- glmer(as.numeric(DIED_HOSP) ~ 0 + IcuAdmitYYYY + pf_cont +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
                             family = binomial(link = "logit"), data = arf, nAGQ = 0,
                             glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
...
arf_model_hosp_mort_cat <- glmer(as.numeric(DIED_HOSP) ~ 0 + IcuAdmitYYYY:pf_cat + IcuAdmitYYYY + pf_cat +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
                             family = binomial(link = "logit"), data = arf, nAGQ = 0,
                             glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
...
# Run MLM
arf_model_icu_mort <- glmer(as.numeric(DIED_ICU) ~ 0 + IcuAdmitYYYY + pf_cont +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
...
# Run MLM for pg_cat interaction term
arf_model_icu_mort_cat <- glmer(as.numeric(DIED_ICU) ~ 0 + IcuAdmitYYYY:pf_cat + IcuAdmitYYYY + pf_cat + FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
                             family = binomial(link = "logit"), data = arf_icu_mort, nAGQ = 0,
                             glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
...
# Run MLM
arf_model_icu_los <- lmer(icu_los ~ 0 + IcuAdmitYYYY + pf_cont +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
                            data = arf_icu_los)

arf_model_icu_los_tidy <-broom::tidy(arf_model_icu_los, conf.int = T)

# Run MLM for pg_cat interaction term
arf_model_icu_los_cat <- lmer(icu_los ~ 0 + IcuAdmitYYYY:pf_cat + IcuAdmitYYYY + pf_cat +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
                            data = arf_icu_los)
...
# Run MLM
arf_model_hosp_los <- lmer(hosp_los ~ 0 + IcuAdmitYYYY + pf_cont +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
                            data = arf_hosp_los)

arf_model_hosp_los_tidy <-broom::tidy(arf_model_hosp_los, conf.int = T)

# Run MLM for pg_cat interaction term
arf_model_hosp_los_cat <- lmer(hosp_los ~ 0 + IcuAdmitYYYY:pf_cat + IcuAdmitYYYY + pf_cat +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
                            data = arf_hosp_los)
...
# Run MLM
arf_model_dc_home <- glmer(dc_home ~ 0 + IcuAdmitYYYY + pf_cont +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
...
# Run MLM for pg_cat interaction term
arf_model_dc_home_cat <- glmer(dc_home ~ 0 + IcuAdmitYYYY:pf_cat + IcuAdmitYYYY + pf_cat +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
                             family = binomial(link = "logit"), data = arf_dc_home, nAGQ = 0,
                             glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
...
# Run MLM
arf_model_dc_nh <- glmer(dc_nh ~ 0 + IcuAdmitYYYY + pf_cont +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
...
# Run MLM for pg_cat interaction term
arf_model_dc_nh_cat <- glmer(dc_nh ~ 0 + IcuAdmitYYYY:pf_cat + IcuAdmitYYYY + pf_cat +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
                             family = binomial(link = "logit"), data = arf_dc_nh, nAGQ = 0,
                             glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
...
# Run MLM
arf_model_dc_other_hosp <- glmer(dc_other_hosp ~ 0 + IcuAdmitYYYY + pf_cont +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
...
# Run MLM for pg_cat interaction term
arf_model_dc_other_hosp_cat <- glmer(dc_other_hosp ~ 0 + IcuAdmitYYYY:pf_cat + IcuAdmitYYYY + pf_cat +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
                             family = binomial(link = "logit"), data = arf_dc_other_hosp, nAGQ = 0,
                             glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
...
time_death <- coxph(Surv(time, status) ~ pf_cat +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + frailty(SiteID), data=arf)
time_death_strata <- coxph(Surv(time, status) ~ strata(pf_cat) +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + frailty(SiteID), data=arf)
time_death_timecat <- coxph(Surv(time, status) ~ time_cat +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + frailty(SiteID), data=arf)
time_death_timecat_strata <- coxph(Surv(time, status) ~ strata(time_cat) +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + frailty(SiteID), data=arf)
time_death_timecat_none <- coxph(Surv(time, status) ~ time_cat +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + frailty(SiteID), data = arf_none)
time_death_timecat_none_strata <- coxph(Surv(time, status) ~ strata(time_cat) +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + frailty(SiteID), data=arf_none)
time_death_timecat_mild <- coxph(Surv(time, status) ~ time_cat +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + frailty(SiteID), data=arf_mild)
time_death_timecat_mild_strata <- coxph(Surv(time, status) ~ strata(time_cat) +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + frailty(SiteID), data=arf_mild)
time_death_timecat_mod <- coxph(Surv(time, status) ~ time_cat +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + frailty(SiteID), data=arf_mod)
time_death_timecat_mod_strata <- coxph(Surv(time, status) ~ strata(time_cat) +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + frailty(SiteID), data=arf_mod)
time_death_timecat_sev <- coxph(Surv(time, status) ~ time_cat +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + frailty(SiteID), data=arf_sev)
time_death_timecat_sev_strata <- coxph(Surv(time, status) ~ strata(time_cat) +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + frailty(SiteID), data=arf_sev)
...
arf_ippv <- arf |> mutate(INV_IND = case_when(
  INV_IND == 0 ~ "No",
  INV_IND == 1 ~ "Yes"))

# Run MLM
arf_model_ippv <- glmer(DIED_HOSP ~ 0 + IcuAdmitYYYY + pf_cont + INV_IND + FRAILTY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
...
# Run MLM
arf_model_niv <- glmer(DIED_HOSP ~ 0 + IcuAdmitYYYY + pf_cont + NIV_IND + FRAILTY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
...
# Run MLM
arf_model_ecmo <- glmer(DIED_HOSP ~ 0 + IcuAdmitYYYY + pf_cont + ECMO_IND + FRAILTY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
...
# Hospital Type
# Run MLM
arf_model_hosptype <- glmer(DIED_HOSP ~ 0 + IcuAdmitYYYY + pf_cont + HospitalClassification + FRAILTY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
                             family = binomial(link = "logit"), data = arf, nAGQ = 0,
                             glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
# G-computation
...
arf_model_sex <- glmer(DIED_HOSP ~ 0 + IcuAdmitYYYY + pf_cont + SEX + FRAILTY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
...
# Age Categories
# Run MLM
arf_model_age <- glmer(DIED_HOSP ~ 0 + IcuAdmitYYYY + pf_cont + age_cat + FRAILTY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
                             family = binomial(link = "logit"), data = arf, nAGQ = 0,
                             glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
# G-computation
...
# Run MLM
arf_model_diag <- glmer(DIED_HOSP ~ 0 + IcuAdmitYYYY + pf_cont + ap3diag_min + FRAILTY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
...
arf_rxlim <- arf |> mutate(TREAT_LMT = case_when(
  ...
  TREAT_LMT == 2 ~ "Yes"))
# Run MLM
arf_model_Rxlim <- glmer(DIED_HOSP ~ 0 + IcuAdmitYYYY + pf_cont + TREAT_LMT + FRAILTY + Apache3Score + CHR_RESP + CHR_CVS + (1|SiteID),
...
# Run MLM
arf_model_ap2 <- glmer(as.numeric(DIED_HOSP) ~ 0 + pf_cont +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + Apache2Score + (1|SiteID),
                             family = binomial(link = "logit"), data = arf, nAGQ = 0,
                             glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
...
# Run MLM
arf_model_anzrod <- glmer(as.numeric(DIED_HOSP) ~ 0 + pf_cont +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + ANZRODRiskOfDeath + (1|SiteID),
                             family = binomial(link = "logit"), data = arf, nAGQ = 0,
                             glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
...
```{r, cache.lazy=FALSE}
# Run MLM
arf_model_sofa <- glmer(as.numeric(DIED_HOSP) ~ 0 + pf_cont +  FRAILTY + SMOKINGINTENSITY + Apache3Score + CHR_RESP + CHR_CVS + SOFA_Score + (1|SiteID),
                             family = binomial(link = "logit"), data = arf, nAGQ = 0,
                             glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 2e5)))
...
# Run MLM
arf_freqmodel <- glmer(as.numeric(DIED_HOSP) ~ 0 + pf_cont +  FRAILTY + SMOKINGINTENSITY + CHR_RESP + CHR_CVS  + Apache3Score + (1|SiteID),
